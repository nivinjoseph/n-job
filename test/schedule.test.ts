...
await describe("Schedule", async () =>
{
    await describe("Single config", async () =>
    {
        ...
        await test("given schedule has config month = 11, when next is calculated with reference 2018-11-12 23:59, then result should be 2018-12-01 00:00", () =>
        {
            const schedule = new Schedule();
        ...
        await test("given schedule has config month = 10, when next is calculated with reference 2018-11-12 23:59, then result should be 2018-11-12 24:00", () =>
        {
            const schedule = new Schedule();
        ...
        await test("given schedule has config month = 10, when next is calculated with reference 2018-11-30 23:59, then result should be 2019-11-01 00:00", () =>
        {
            const schedule = new Schedule();
            schedule.setMonth(10);
    ...
    await describe("Multiple config", async () =>
    {
        ...
        await test("given schedule has config dayOfMonth = 12 month = 1, when next is calculated with reference 2018-11-30 12:12, then result should be 2019-02-12 00:00", () =>
        {
            const schedule = new Schedule();
            schedule.setDayOfMonth(12);
            schedule.setMonth(1);
        ...
        await test("given schedule has config month = 0 dayOfMonth = 6 hour = 12 min = 12, when next is calculated with reference 2018-11-13 12:12, then result should be 2019-01-06 12:12", () =>
        {
            const schedule = new Schedule();
            schedule.setHour(12);
            schedule.setMinute(12);
        ...
        await test("given schedule has config month = 0 dayOfMonth = 1 hour = 0 min = 0, when next is calculated with reference 2019-01-01 00:00, then result should be 2020-01-01 00:00", () =>
        {
            const schedule = new Schedule();
            schedule.setHour(0);
        ...
        await test("given schedule has config month = 1 dayOfMonth = 31, when next is calculated with reference 2019-01-01 00:00, then InvalidScheduleException should be thrown", () =>
        {
            const schedule = new Schedule();
        ...
        await test("given schedule has config month = 10 dayOfMonth = 31, when next is calculated with reference 2019-01-01 00:00, then InvalidScheduleException should thrown", () =>
        {
            const schedule = new Schedule();
            schedule.setDayOfMonth(31);
            schedule.setMonth(10);
        ...
        await test("given schedule has config month = 1 dayOfMonth = 29 hour, when next is calculated with reference 2018-01-01 00:00, then then result should be 2020-02-29 00:00", () =>
        {
            const schedule = new Schedule();
